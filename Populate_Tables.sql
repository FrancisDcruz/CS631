...
INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),1,4,3,7);
INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),2,2,1,1);
INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),6,7,4,6);
INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),1,5,2,4);
INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),5,3,3,1);
INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),3,2,4,2);



INSERT INTO BORROWING (BDTIME,RDTIME,DUEDATE) VALUES('2012-12-03','2012-12-05','2012-12-23');INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),4,1,1,1);
INSERT INTO BORROWING (BDTIME,RDTIME,DUEDATE) VALUES('2012-12-04',NULL,'2012-12-24');INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),1,1,1,3);
INSERT INTO BORROWING (BDTIME,RDTIME,DUEDATE) VALUES('2012-12-05',NULL,'2012-12-25');INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),2,2,1,2);
INSERT INTO BORROWING (BDTIME,RDTIME,DUEDATE) VALUES('2012-12-06','2012-12-15','2012-12-26');INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),6,3,2,4);
INSERT INTO BORROWING (BDTIME,RDTIME,DUEDATE) VALUES('2012-12-07',NULL,'2012-12-27');INSERT INTO BORROWS (BOR_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(BOR_NO) FROM BORROWING ),1,4,2,5);



INSERT INTO RESERVATION (DTIME) VALUES('2012-12-03');INSERT INTO RESERVES (RESERVATION_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(RES_NO) FROM RESERVATION ),1,5,3,6);
INSERT INTO RESERVATION (DTIME) VALUES('2012-12-04');INSERT INTO RESERVES (RESERVATION_NO,RID,DOCID,BID,COPYNO) VALUES((SELECT MAX(RES_NO) FROM RESERVATION ),4,6,4,7);
...
#Copy
INSERT INTO `COPY`(`DOCID`, `BID`, `COPYNO`,`POSITION`) VALUES (1,1,1,'SA-Q-124');
INSERT INTO `COPY`(`DOCID`, `BID`, `COPYNO`,`POSITION`) VALUES (2,1,2,'SB-K-5223');
INSERT INTO `COPY`(`DOCID`, `BID`, `COPYNO` ,`POSITION`) VALUES (1,1,3,'SQ-G-123');
INSERT INTO `COPY`(`DOCID`, `BID`, `COPYNO`,`POSITION`) VALUES (3,2,4,'SD-F-4563');
INSERT INTO `COPY`(`DOCID`, `BID`, `COPYNO`, `POSITION`) VALUES (4,2,5,'DE-G-3456');
INSERT INTO `COPY`(`DOCID`, `BID`, `COPYNO`,`POSITION`) VALUES (5,3,3,'FD-F-1520');
INSERT INTO `COPY`(`DOCID`, `BID`, `COPYNO`, `POSITION`) VALUES (6,1,2,'JC-G-1997');
...
#Chairs
INSERT INTO `CHAIRS`(`PID`, `DOCID`) VALUES (1,3);
INSERT INTO `CHAIRS`(`PID`, `DOCID`) VALUES (2,7);
INSERT INTO `CHAIRS`(`PID`, `DOCID`) VALUES (4,5);
INSERT INTO `CHAIRS`(`PID`, `DOCID`) VALUES (5,4);
...
#Journal Issue
INSERT INTO `JOURNAL_ISSUE`(`DOCID`, `SCOPE`) VALUES (1,'POLITICS');
INSERT INTO `JOURNAL_ISSUE`(`DOCID`, `SCOPE`) VALUES (3,'TECH');
INSERT INTO `JOURNAL_ISSUE`(`DOCID`, `SCOPE`) VALUES (5,'BIOLOGY');
INSERT INTO `JOURNAL_ISSUE`(`DOCID`, `SCOPE`) VALUES (7,'SOCIAL');
INSERT INTO `JOURNAL_ISSUE`(`DOCID`, `SCOPE`) VALUES (9,'TECH');
